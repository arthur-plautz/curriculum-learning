...
class StatsGroupAnalytics:
    ...
    def load_data(self):
        ...
        for seed in self.seeds:
            group = SpecialistsGroup(self.data_folder, self.specialists, seed, 'stats', self.target_columns)
    ...
    def get_stats(self, columns):
        if len(columns) == CM_COLUMNS:
            ...
            stats = {}
            for specialist in self.specialists:
                stats[specialist] = process_cm_metrics(data.get(specialist), columns)
